...
Your Getembe Welfare Community account has been created.
...
Regards,
Getembe Welfare Community Team
    `.trim(),
  })
}
...
There is a new announcement from the Getembe Welfare Community.
...
Your one-time verification code for Getembe Welfare Community is:
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px">
        ...
        <p style="font-size:12px;color:#94a3b8;text-align:center;margin:0">
          Getembe Welfare Community · Nakuru, Kenya
        </p>
      </div>
    `,
  })
...
A password reset has been requested for your Getembe Welfare Community account.
...
const sendAccountStatusEmail = async ({ email, fullName, status }) => {
  ...
  const statusConfig = {
    ACTIVE: {
      ...
      body: `Your Getembe Welfare Community account has been activated. You can now log in and access all member services.`,
      cta:     true,
    },
    INACTIVE: {
      ...
      body: `Your Getembe Welfare Community account has been temporarily deactivated by the administrator. You will not be able to log in until it is reactivated.\n\nIf you believe this is an error or would like to request reactivation, please contact your welfare administrator.`,
      cta:     false,
    },
    ANONYMISED: {
      ...
      body: `As requested, your personal information has been removed from the Getembe Welfare Community system. This action is permanent and your account can no longer be restored.\n\nThank you for being a member of Getembe Welfare Community.`,
      cta:     false,
    },
  }
