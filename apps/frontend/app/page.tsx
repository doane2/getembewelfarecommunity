          ...
          <div className="about-grid">
            <div>
              ...
              <p style={{ fontSize: 15, color: '#475569', lineHeight: 1.8, marginBottom: 16 }}>
                Founded in 2016, Getembe Welfare Community has served families across Crater Seventh Day Adventist Church with the belief that collective strength lifts every individual. We are member-owned, member-governed and driven by the values of our faith community.
              </p>
