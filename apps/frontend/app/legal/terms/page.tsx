...
const sections = [
  {
    ...
    content: `These Terms of Service ("Terms") govern your access to and use of the Getembe Welfare Community digital platform ("Platform"), operated by Getembe Welfare Community ("Society", "we", "us", or "our"), a member-owned welfare society registered and operating in Nakuru, Kenya.\n\nBy activating your member account, logging in, or using any part of the Platform, you agree to be bound by these Terms. If you do not agree, you must not use the Platform.`,
  },
  {
    ...
    <div style={{ background: '#091529', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', padding: '24px 40px', textAlign: 'center' }}>
        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.2)' }}>
          © {new Date().getFullYear()} Getembe Welfare Community · Nakuru, Kenya
        </p>
