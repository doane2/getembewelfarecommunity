    ...
    <div style={{ background: '#091529', minHeight: '100vh', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="legal-wrap">
        ...
        <div id="ps1" className="legal-section">
          ...
          <p className="legal-p">Getembe Welfare Community ("Society", "we", "us") is committed to protecting the privacy of our members and beneficiaries. This Privacy Policy explains how we collect, use, store and protect your personal data when you use our Platform.</p>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', padding: '24px 40px', textAlign: 'center' }}>
        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.2)' }}>© {new Date().getFullYear()} Getembe Welfare Community · Nakuru, Kenya</p>
